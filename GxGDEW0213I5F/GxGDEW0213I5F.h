...
//
// based on Demo Example from Good Display, available here: http://www.good-display.com/download_detail/downloadsId=599.html
...
class GxGDEW0213I5F : public GxEPD
{
  ...
  private:
#if defined(__AVR)
    uint8_t _black_buffer[GxGDEW0213I5F_PAGE_SIZE];
    uint8_t _red_buffer[GxGDEW0213I5F_PAGE_SIZE];
#else
    uint8_t _black_buffer[GxGDEW0213I5F_BUFFER_SIZE];
    uint8_t _red_buffer[GxGDEW0213I5F_BUFFER_SIZE];
#endif
    GxIO& IO;
