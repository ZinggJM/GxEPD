...
#ifndef _GxGDEW0154M10_H_
#define _GxGDEW0154M10_H_

#include "../GxEPD.h"

#define GxGDEW0154M10_WIDTH 152
#define GxGDEW0154M10_HEIGHT 152

#define GxGDEW0154M10_BUFFER_SIZE (uint32_t(GxGDEW0154M10_WIDTH) * uint32_t(GxGDEW0154M10_HEIGHT) / 8)

// divisor for AVR, should be factor of GxGDEW0154M10_HEIGHT
#define GxGDEW0154M10_PAGES 8

#define GxGDEW0154M10_PAGE_HEIGHT (GxGDEW0154M10_HEIGHT / GxGDEW0154M10_PAGES)
#define GxGDEW0154M10_PAGE_SIZE (GxGDEW0154M10_BUFFER_SIZE / GxGDEW0154M10_PAGES)

class GxGDEW0154M10 : public GxEPD
{
  public:
#if defined(ESP8266)
    //GxGDEW0154M10(GxIO& io, int8_t rst = D4, int8_t busy = D2);
    // use pin numbers, other ESP8266 than Wemos may not use Dx names
    GxGDEW0154M10(GxIO& io, int8_t rst = 2, int8_t busy = 4);
#else
    GxGDEW0154M10(GxIO& io, int8_t rst = 9, int8_t busy = 7);
#endif
    ...
    void powerDown();
    // paged drawing, for limited RAM, drawCallback() is called GxGDEW0154M10_PAGES times
  ...
  private:
#if defined(__AVR)
    uint8_t _buffer[GxGDEW0154M10_PAGE_SIZE];
#else
    uint8_t _buffer[GxGDEW0154M10_BUFFER_SIZE];
#endif
    GxIO& IO;
...
#ifndef GxEPD_Class
#define GxEPD_Class GxGDEW0154M10
#define GxEPD_WIDTH GxGDEW0154M10_WIDTH
#define GxEPD_HEIGHT GxGDEW0154M10_HEIGHT
#define GxEPD_BitmapExamples <GxGDEW0154M10/BitmapExamples.h>
#define GxEPD_BitmapExamplesQ "GxGDEW0154M10/BitmapExamples.h"
#endif
