...
class GxDEPG0150BN : public GxEPD
{
  ...
  private:
    ...
    static const uint16_t power_off_time = 150; // ms, e.g. 141192us
    static const uint16_t full_refresh_time = 4000; // ms, e.g. 3969108us
    static const uint16_t partial_refresh_time = 900; // ms, e.g. 878524us
