...
#ifndef _GxGDEH0154Z90_H_
#define _GxGDEH0154Z90_H_

#include "../GxEPD.h"

#define GxGDEH0154Z90_WIDTH 200
#define GxGDEH0154Z90_HEIGHT 200

#define GxGDEH0154Z90_BUFFER_SIZE (uint32_t(GxGDEH0154Z90_WIDTH) * uint32_t(GxGDEH0154Z90_HEIGHT) / 8)

// divisor for AVR, should be factor of GxGDEH0154Z90_HEIGHT
#define GxGDEH0154Z90_PAGES 10

#define GxGDEH0154Z90_PAGE_HEIGHT (GxGDEH0154Z90_HEIGHT / GxGDEH0154Z90_PAGES)
#define GxGDEH0154Z90_PAGE_SIZE (GxGDEH0154Z90_BUFFER_SIZE / GxGDEH0154Z90_PAGES)

class GxGDEH0154Z90 : public GxEPD
{
  public:
    static const bool usePartialUpdateWindow = false; // needs be false, controller issue
#if defined(ESP8266)
    //GxGDEH0154Z90(GxIO& io, int8_t rst = D4, int8_t busy = D2);
    // use pin numbers, other ESP8266 than Wemos may not use Dx names
    GxGDEH0154Z90(GxIO& io, int8_t rst = 2, int8_t busy = 4);
#else
    GxGDEH0154Z90(GxIO& io, int8_t rst = 9, int8_t busy = 7);
#endif
    ...
    void powerDown();
    // paged drawing, for limited RAM, drawCallback() is called GxGDEH0154Z90_PAGES times
  ...
  private:
#if defined(__AVR)
    uint8_t _black_buffer[GxGDEH0154Z90_PAGE_SIZE];
    uint8_t _red_buffer[GxGDEH0154Z90_PAGE_SIZE];
#else
    uint8_t _black_buffer[GxGDEH0154Z90_BUFFER_SIZE];
    uint8_t _red_buffer[GxGDEH0154Z90_BUFFER_SIZE];
#endif
    GxIO& IO;
...
#ifndef GxEPD_Class
#define GxEPD_Class GxGDEH0154Z90
#define GxEPD_WIDTH GxGDEH0154Z90_WIDTH
#define GxEPD_HEIGHT GxGDEH0154Z90_HEIGHT
#define GxEPD_BitmapExamples <GxGDEH0154Z90/BitmapExamples.h>
#define GxEPD_BitmapExamplesQ "GxGDEH0154Z90/BitmapExamples.h"
#endif
