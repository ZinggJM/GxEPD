  ...
  if (using_rotation)
  {
    switch (getRotation())
    {
      case 1:
        ...
        swap(xd, yd);
        swap(w, h);
        xs = GxGDEW029T5D_WIDTH - xs - w;
        xd = GxGDEW029T5D_WIDTH - xd - w;
        break;
      case 2:
        xs = GxGDEW029T5D_WIDTH - xs - w;
        ys = GxGDEW029T5D_HEIGHT - ys - h;
        xd = GxGDEW029T5D_WIDTH - xd - w;
        yd = GxGDEW029T5D_HEIGHT - yd - h;
        break;
      case 3:
        swap(xs, ys);
        swap(xd, yd);
...
void GxGDEW029T5D::_rotate(uint16_t& x, uint16_t& y, uint16_t& w, uint16_t& h)
{
  switch (getRotation())
  {
    case 1:
      swap(x, y);
      swap(w, h);
      x = GxGDEW029T5D_WIDTH - x - w;
      break;
    case 2:
      x = GxGDEW029T5D_WIDTH - x - w;
      y = GxGDEW029T5D_HEIGHT - y - h;
      break;
    case 3:
      swap(x, y);
      swap(w, h);
