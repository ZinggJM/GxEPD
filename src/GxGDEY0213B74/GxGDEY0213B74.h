...
#ifndef _GxGDEY0213B74_H_
#define _GxGDEY0213B74_H_

#include <Arduino.h>
#include "../GxEPD.h"

// the physical number of pixels (for controller parameter)
#define GxGDEY0213B74_X_PIXELS 128
#define GxGDEY0213B74_Y_PIXELS 250

#define GxGDEY0213B74_WIDTH GxGDEY0213B74_X_PIXELS
#define GxGDEY0213B74_HEIGHT GxGDEY0213B74_Y_PIXELS

#define GxGDEY0213B74_BUFFER_SIZE (uint32_t(GxGDEY0213B74_WIDTH) * uint32_t(GxGDEY0213B74_HEIGHT) / 8)

// divisor for AVR, should be factor of GxGDEY0213B74_HEIGHT
#define GxGDEY0213B74_PAGES 8

#define GxGDEY0213B74_PAGE_HEIGHT (GxGDEY0213B74_HEIGHT / GxGDEY0213B74_PAGES)
#define GxGDEY0213B74_PAGE_SIZE (GxGDEY0213B74_BUFFER_SIZE / GxGDEY0213B74_PAGES)

class GxGDEY0213B74 : public GxEPD
{
  public:
#if defined(ESP8266)
    GxGDEY0213B74(GxIO& io, int8_t rst = 2, int8_t busy = 4);
#else
    GxGDEY0213B74(GxIO& io, int8_t rst = 9, int8_t busy = 7);
#endif
    ...
    void powerDown();
    // paged drawing, for limited RAM, drawCallback() is called GxGDEY0213B74_PAGES times
  ...
  protected:
#if defined(__AVR)
    uint8_t _buffer[GxGDEY0213B74_PAGE_SIZE];
#else
    uint8_t _buffer[GxGDEY0213B74_BUFFER_SIZE];
#endif
  private:
    GxIO& IO;
    ...
    static const uint16_t full_refresh_time = 3000; // ms, e.g. 2097292us
    static const uint16_t partial_refresh_time = 420; // ms, e.g. 460124us
...
#ifndef GxEPD_Class
#define GxEPD_Class GxGDEY0213B74
#define GxEPD_WIDTH GxGDEY0213B74_WIDTH
#define GxEPD_HEIGHT GxGDEY0213B74_HEIGHT
#define GxEPD_BitmapExamples <GxGDEY0213B74/BitmapExamples.h>
#define GxEPD_BitmapExamplesQ "GxGDEY0213B74/BitmapExamples.h"
#endif
