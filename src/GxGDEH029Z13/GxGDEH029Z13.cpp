  ...
  if (using_rotation)
  {
    switch (getRotation())
    {
      case 1:
        ...
        swap(xd, yd);
        swap(w, h);
        xs = GxGDEH029Z13_WIDTH - xs - w;
        xd = GxGDEH029Z13_WIDTH - xd - w;
        break;
      case 2:
        xs = GxGDEH029Z13_WIDTH - xs - w;
        ys = GxGDEH029Z13_HEIGHT - ys - h;
        xd = GxGDEH029Z13_WIDTH - xd - w;
        yd = GxGDEH029Z13_HEIGHT - yd - h;
        break;
      case 3:
        swap(xs, ys);
        swap(xd, yd);
...
void GxGDEH029Z13::_rotate(uint16_t& x, uint16_t& y, uint16_t& w, uint16_t& h)
{
  switch (getRotation())
  {
    case 1:
      swap(x, y);
      swap(w, h);
      x = GxGDEH029Z13_WIDTH - x - w;
      break;
    case 2:
      x = GxGDEH029Z13_WIDTH - x - w;
      y = GxGDEH029Z13_HEIGHT - y - h;
      break;
    case 3:
      swap(x, y);
      swap(w, h);
