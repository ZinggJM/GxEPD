...
#ifndef _GxGDEW0154T8_H_
#define _GxGDEW0154T8_H_

#include "../GxEPD.h"

#define GxGDEW0154T8_WIDTH 152
#define GxGDEW0154T8_HEIGHT 152

#define GxGDEW0154T8_BUFFER_SIZE (uint32_t(GxGDEW0154T8_WIDTH) * uint32_t(GxGDEW0154T8_HEIGHT) / 8)

// divisor for AVR, should be factor of GxGDEW0154T8_HEIGHT
#define GxGDEW0154T8_PAGES 8

#define GxGDEW0154T8_PAGE_HEIGHT (GxGDEW0154T8_HEIGHT / GxGDEW0154T8_PAGES)
#define GxGDEW0154T8_PAGE_SIZE (GxGDEW0154T8_BUFFER_SIZE / GxGDEW0154T8_PAGES)

class GxGDEW0154T8 : public GxEPD
{
  public:
#if defined(ESP8266)
    //GxGDEW0154T8(GxIO& io, int8_t rst = D4, int8_t busy = D2);
    // use pin numbers, other ESP8266 than Wemos may not use Dx names
    GxGDEW0154T8(GxIO& io, int8_t rst = 2, int8_t busy = 4);
#else
    GxGDEW0154T8(GxIO& io, int8_t rst = 9, int8_t busy = 7);
#endif
    ...
    void powerDown();
    // paged drawing, for limited RAM, drawCallback() is called GxGDEW0154T8_PAGES times
  ...
  private:
#if defined(__AVR)
    uint8_t _buffer[GxGDEW0154T8_PAGE_SIZE];
#else
    uint8_t _buffer[GxGDEW0154T8_BUFFER_SIZE];
#endif
    GxIO& IO;
...
#ifndef GxEPD_Class
#define GxEPD_Class GxGDEW0154T8
#define GxEPD_WIDTH GxGDEW0154T8_WIDTH
#define GxEPD_HEIGHT GxGDEW0154T8_HEIGHT
#define GxEPD_BitmapExamples <GxGDEW0154T8/BitmapExamples.h>
#define GxEPD_BitmapExamplesQ "GxGDEW0154T8/BitmapExamples.h"
#endif
