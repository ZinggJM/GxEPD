  ...
  if (using_rotation)
  {
    switch (getRotation())
    {
      case 1:
        ...
        swap(xd, yd);
        swap(w, h);
        xs = GxGDEY027T91_WIDTH - xs - w;
        xd = GxGDEY027T91_WIDTH - xd - w;
        break;
      case 2:
        xs = GxGDEY027T91_WIDTH - xs - w;
        ys = GxGDEY027T91_HEIGHT - ys - h;
        xd = GxGDEY027T91_WIDTH - xd - w;
        yd = GxGDEY027T91_HEIGHT - yd - h;
        break;
      case 3:
        swap(xs, ys);
        swap(xd, yd);
...
void GxGDEY027T91::_rotate(uint16_t& x, uint16_t& y, uint16_t& w, uint16_t& h)
{
  switch (getRotation())
  {
    case 1:
      swap(x, y);
      swap(w, h);
      x = GxGDEY027T91_WIDTH - x - w;
      break;
    case 2:
      x = GxGDEY027T91_WIDTH - x - w;
      y = GxGDEY027T91_HEIGHT - y - h;
      break;
    case 3:
      swap(x, y);
      swap(w, h);
