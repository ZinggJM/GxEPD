...
void GxGDE0213B1::drawBitmap_TestRamEntryMode(const uint8_t *bitmap, uint32_t size, uint8_t rdem)
{
...
void GxGDE0213B1::_setRamDataEntryMode(uint8_t rdem)
{
  rdem = min(rdem, 0x03);
  _writeCommand(0x11);
  _writeData(rdem);
...
void GxGDE0213B1::_InitDisplay(uint8_t rdem)
{
...
void GxGDE0213B1::_Init_Full(uint8_t rdem)
{
  _InitDisplay(rdem);
...
void GxGDE0213B1::_Init_Part(uint8_t rdem)
{
  _InitDisplay(rdem);
...
void GxGDE0213B1::drawCornerTest(uint8_t rdem)
{
  _Init_Full(rdem);
  _writeCommand(0x24);
