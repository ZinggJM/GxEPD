...
void GxGDEH029A1::drawBitmap_TestRamEntryMode(const uint8_t *bitmap, uint32_t size, uint8_t rdem)
{
...
void GxGDEH029A1::_setRamDataEntryMode(uint8_t rdem)
{
  rdem = min(rdem, 0x03);
  _writeCommand(0x11);
  _writeData(rdem);
...
void GxGDEH029A1::_InitDisplay(uint8_t rdem)
{
...
void GxGDEH029A1::_Init_Full(uint8_t rdem)
{
  _InitDisplay(rdem);
...
void GxGDEH029A1::_Init_Part(uint8_t rdem)
{
  _InitDisplay(rdem);
...
void GxGDEH029A1::drawCornerTest(uint8_t rdem)
{
  _Init_Full(rdem);
  _writeCommand(0x24);
